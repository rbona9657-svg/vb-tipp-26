...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-dvh bg-bg-primary text-text-primary">
      {/* ─── Navbar ─── */}
      <nav className="sticky top-0 z-50 bg-bg-primary/95 backdrop-blur-sm border-b border-border-subtle" style={{ paddingTop: "env(safe-area-inset-top)" }}>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="bg-gradient-to-b from-[#0b0d17] via-[#141729] to-[#0b0d17] text-white">
          ...
          <div className="relative max-w-4xl mx-auto px-5 pt-16 pb-20 text-center">
            <Image
              src="/images/logo.png?v=ziccer3"
              alt="Ziccer Tipper"
              width={180}
              height={180}
              className="mx-auto mb-6 rounded-[var(--radius-xl)]"
              priority
              unoptimized
            />
